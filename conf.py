...
Conf["master_name"] = "nezirin"
# 管理用マスターパスワード ※他人に知られてはいけない
Conf["master_password"] = "eclipse"
...
# 各ユーザーデータ格納フォルダ（適当な名前を付けてください）
Conf["savedir"] = "save"
# モンスターデータやショップデータ等各_dat.csv格納フォルダ（初期dat）
Conf["datdir"] = "dat"
